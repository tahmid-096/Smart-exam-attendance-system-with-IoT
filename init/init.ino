...
#define FIREBASE_HOST "examiot-c4811-default-rtdb.firebaseio.com" //Without http:// or https:// schemes
#define FIREBASE_AUTH "AIzaSyCd_RZnHhN-qvncKqpr4Ak_IUPFCS-xyTs"
RFID rfid(D8, D0);       //D8:pin of tag reader SDA. D0:pin of tag reader RST 
unsigned char str[MAX_LEN]; //MAX_LEN is 16: size of the array 

const char ssid[] = "IOT LAB";
const char pass[] = "iotlab@507";
